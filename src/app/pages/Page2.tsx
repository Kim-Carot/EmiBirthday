      ...
      <div className="relative z-10 w-full h-full flex flex-row items-center justify-between px-12 py-8">
        ...
        <div className="flex-1 flex flex-col items-center justify-between h-full py-8">
          ...
          <div className="flex items-center justify-center pb-4">
            <img src={foxImg} alt="Fox" className="w-29 h-32 object-contain" style={{ margin: "1px" }} />
            <img src={duckImg} alt="Duck" className="w-29 h-32 object-contain" style={{ margin: "1px" }} />
            <img src={mouseWithCupcakeImg} alt="Mouse with Cupcake" className="w-29 h-29 object-contain" style={{ margin: "1px" }} />
            <img src={miceCakeImg} alt="Mice with Cake" className="w-29 h-29 object-contain" style={{ margin: "1px" }} />
            <img src={cupcakeStandImg} alt="Cupcake Stand" className="w-29 h-32 object-contain" style={{ margin: "1px" }} />
          </div>
        </div>
      </div>
    </div>
